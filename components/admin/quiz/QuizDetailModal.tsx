                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="space-y-2">
                                                {question.options.map((option, optIndex) => (
                                                    <div
                                                        key={optIndex}
                                                        className={`flex items-center gap-3 p-3 rounded-lg border cursor-default ${optIndex === question.correctAnswerIndex
                                                                ? "bg-green-50 border-green-200 text-green-800"
                                                                : "bg-slate-50 border-slate-200"
                                                            }`}
                                                    >
                                                        <div
                                                            className={`w-4 h-4 rounded-full border-2 ${optIndex === question.correctAnswerIndex
