    ...
    <div className="container mx-auto py-16 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 ml-16 pt-10">
        <div className="flex flex-col items-start">
          ...
          <h3 className="text-2xl font-bold mb-3">Confidence in Speaking</h3>
          <p className="text-gray-600 text-lg mr-20">
        ...
        <div className="flex flex-col items-start">
          ...
          <h3 className="text-2xl font-bold mb-3">Finding Time</h3>
          <p className="text-gray-600 text-lg mr-20">
        ...
        <div className="flex flex-col items-start">
          ...
          <h3 className="text-2xl font-bold mb-3">Lessons Aren't Practical</h3>
          <p className="text-gray-600 text-lg mr-20">
