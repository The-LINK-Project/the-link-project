            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 ml-16 pt-10">
                <div className="flex flex-col items-start">
                    ...
                    <p className="text-gray-600 text-lg mr-20 font-light">
                        Despite understanding some English, speaking clearly in daily life
                        or at work can still feel stressful or uncertain.
                    </p>
                </div>
                <div className="flex flex-col items-start">
                    <div className="bg-main-blue p-4 rounded-full mb-4">
                    ...
                    <p className="text-gray-600 text-lg mr-20 font-light">
                        With busy working hours and changing schedules, finding time to
                        attend classes or stay consistent with learning can be difficult.
                    </p>
                </div>
                ...
                <div className="flex flex-col items-start">
                    ...
                    <h3 className="text-xl font-semibold mb-3">
                        Lessons Aren't Practical
                    </h3>
                    <p className="text-gray-600 text-lg mr-20 font-light">
                        Many learning tools focus on exams or formal English, making it hard
                        to apply what’s learned to real conversations and everyday
                        situations.
                    </p>
                </div>
            </div>
